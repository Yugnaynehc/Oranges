...
PUBLIC void init_port()
{
    ...
    /* init all gate as interrupt gate(no trap gate) */
...
{
    int i;
    int text_color = 0x74;      /* gray back and red font */
    ...
    /* clean the first 5 lines of screen, set disp_pos = 0 */
    disp_pos = 0;
    for (i = 0; i< 80*5; ++i) {
        disp_str(" ");
    }
